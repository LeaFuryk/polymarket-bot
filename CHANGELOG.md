...
- **Edge-based strategy configs for all models** — Re-ran walk-forward grid search with edge parameters. RF: min_edge=0.05, Sharpe 1.69, 98.2% WR, +1652% return. LR: min_edge=0.05, Sharpe 0.06, +64%. XGB: min_edge=0.05, Sharpe 0.06, +46%. DNN: min_edge=0.15, Sharpe -0.02 (unprofitable).
