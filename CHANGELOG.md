...
### Added
- **Deep analysis functions** — `analyze_entry_quality`, `analyze_side_accuracy`, `analyze_missed_opportunities` in `analysis/deep.py`: pure stateless functions for post-run analysis of entry quality distribution, per-side win rates, and missed high-move candles
